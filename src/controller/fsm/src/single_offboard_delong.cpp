            ...
            {   
               /*----------search ring----------*/
                if( (flag_ring == 0) || (flag_ring == 5) || (flag_ring == 10) )
                {
                    ...
                    Set_PosAim(pos_drone_now[0] + pos_drone_temp[0], pos_drone_now[1] + pos_drone_temp[1], 1.2);
                    local_pos_pub.publish(aim);
                    ROS_INFO("Rec: %d, flag: %d, recog: %d, count: %d, %.3lf,  %d, %.3f", cmdd, flag_ring, flag_ring_recog, count_ring, aim.pose.position.x, search_direct, pos_drone_temp[1]);
                ...
                {    
                    Set_PosAim(pos_drone_now[0] + pos_drone_temp[0], pos_drone_now[1] + pos_drone_temp[1], 1.2);
		            local_pos_pub.publish(aim);
                    ROS_INFO("Rec: %d, flag: %d, recog: %d, count: %d, %.3lf, %d, %.3lf", cmdd, flag_ring, flag_ring_recog, count_ring, aim.pose.position.x, search_direct, pos_drone_temp[1] );
